...
def LSAC(Ib, Ig, Ir, depth, blockSize,ab,ag,ar,p, sigma_d = 0.08):
    ...
    imgbDark[:, :] = depth_weighted_five_point(ab, depth, sigma_d=0.08)
    imggDark[:, :] = depth_weighted_five_point(ag, depth, sigma_d=0.08)
    imgrDark[:, :] = depth_weighted_five_point(ar, depth, sigma_d=0.08)
...
for i in range(1000):
    if i == 0:
        imgbMiddle,imggMiddle,imgrMiddle,imgab,imgag,imgar,lossb,lossg,lossr = LSAC(Ib,Ig,Ir, depth, 2,initab,initag,initar,0.001, sigma_d = 0.08)
        ...
        imgbMiddle,imggMiddle,imgrMiddle,imgab,imgag,imgar,lossb,lossg,lossr = LSAC(Ib,Ig,Ir, depth, 2,imgbMiddle,imggMiddle,imgrMiddle,0.001, sigma_d = 0.08)
        if max(lossb, lossg, lossr) < 0.001: # another improvement: Instead of arbitrary 1000 loops, use the loss
            break
